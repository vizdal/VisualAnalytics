...
d3.csv("femaledata.csv").then(function(data){
    for(let i = 0; i < data.length;i++){
        d3.select(femaledata).append({"year":data[i].year,"female":data[i].female,"happy":data[i].happy})
        // console.log(data[i].female)
    } });
d3.csv("maledata.csv").then(function(data){
    for(let i = 0; i < data.length;i++){
        d3.select(maledata).append({"year":data[i].year,"male":data[i].male,"happy":data[i].happy})
    } });
var dataSet = [

    {"year": "1994", "value": 0.67},
    {"year": "1994", "value": 0.56},
    {"year": 1996, "value": 0.58},
    {"year": 1996, "value": 0.64},
    {"year": 1998, "value": 0.74},
    {"year": 1998, "value": 0.77},
    {"year": 2000, "value": 0.56},
    {"year": 2000, "value": 0.65},
    {"year": 2002, "value": 0.66},
    {"year": 2002, "value": 0.72},
    {"year": 2004, "value": 0.54},
    {"year": 2004, "value": 0.64},
    {"year": 2006, "value": 0.67},
    {"year": 2006, "value": 0.59},
